...
There are (N - k + 1)^2 possible k-mer pairings between our two sequences out of a possible $2^k$, k-mers. Given that N = 1000 is a reasonable average length for some sequence in a database, our approximation becomes $$p = \frac{(1001-k)^2}{2^k}.$$
